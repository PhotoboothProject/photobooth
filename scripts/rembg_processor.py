...
def apply_rembg(input_path, background_path, model, alpha_matting, max_size, output_path, alpha_matting_foreground_threshold, alpha_matting_background_threshold, alpha_matting_erode_size, post_processing):
    ...
    if alpha_matting_foreground_threshold is not None:
        session_kwargs['alpha_matting_foreground_threshold'] = alpha_matting_foreground_threshold
    if alpha_matting_background_threshold is not None:
        session_kwargs['alpha_matting_background_threshold'] = alpha_matting_background_threshold
...
if __name__ == "__main__":
    if len(sys.argv) != 11:
        print("Usage: python rembg_processor.py <input_image> <background_image> <model> <alpha_matting> <max_size> <output_image> <alpha_matting_foreground_threshold> <alpha_matting_background_threshold> <alpha_matting_erode_size> <post_processing>")
        sys.exit(1)
    ...
    apply_rembg(input_path, background_path, model, alpha_matting, max_size, output_path, alpha_matting_foreground_threshold, alpha_matting_background_threshold, alpha_matting_erode_size, post_processing)
