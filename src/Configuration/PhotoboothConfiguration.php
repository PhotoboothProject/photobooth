    ...
    protected function addPicture(): NodeDefinition
    {
        return (new TreeBuilder('picture'))->getRootNode()->addDefaultsIfNotSet()
            ...
            ->children()
                ...
                ->booleanNode('allow_delete')->defaultValue(true)->end()
                ->booleanNode('rembg_enabled')->defaultValue(false)->end()
                ->scalarNode('rembg_background')->defaultValue('')->end()
                ->enumNode('rembg_model')
                    ->values(['u2net', 'u2netp', 'u2net_cloth_seg', 'u2net_human_seg', 'silueta', 'isnet_general_use', 'isnet_anime'])
                    ->defaultValue('u2net')
                    ->end()
                ->booleanNode('rembg_alpha_matting')->defaultValue(true)->end()
                ->integerNode('rembg_alpha_matting_foreground_threshold')
                    ->defaultValue(240)
                    ->min(0)
                    ->max(255)
                    ->beforeNormalization()
                        ...
                        ->end()
                    ->end()
                ->integerNode('rembg_alpha_matting_background_threshold')
                    ->defaultValue(10)
                    ->min(0)
                    ->max(255)
                    ->beforeNormalization()
                        ...
                        ->end()
                    ->end()
                ->integerNode('rembg_alpha_matting_erode_size')
                    ->defaultValue(10)
                    ->min(0)
                    ->max(255)
                    ->beforeNormalization()
                        ...
                        ->end()
                    ->end()
                ->booleanNode('rembg_post_processing')->defaultValue(false)->end()
                ->integerNode('rembg_max_size')
                    ->defaultValue(1024)
                    ->min(256)
                    ->max(4096)
                    ->beforeNormalization()
