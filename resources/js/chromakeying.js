...
function printImage() {
    ...
    setTimeout(function () {
        $.post('api/chromakeying/print.php', {imgData: dataURL,
            mainImageSrc: mainImageSrc}, function() {
                setTimeout(function () {
...
function saveImage() {
    ...
    setTimeout(function () {
        $.post('api/chromakeying/save.php', {imgData: dataURL,
            mainImageSrc: mainImageSrc}, function() {
                setTimeout(function () {
