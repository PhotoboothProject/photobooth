...
- make sure your camera is working on Photobooth without setting up go2rtc for preview (**if not tested:** uninstall go2rtc while running the [Photobooth Setup Wizard](../install/setup_wizard)  again: 4 go2rtc -> 6 Uninstall go2rtc and the related services).
