...
<div class="<?php echo $uiShape; ?> send-mail">
    ...
    <form id="send-mail-form" style="margin: 0;">
        ...
        <button class="btn <?php echo $btnShape; ?> mail-form-input rotaryfocus" name="submit" type="submit" value="Send"><?=$languageService->translate('add')?></button>
        <?php else: ?>
        <button class="btn <?php echo $btnShape; ?> mail-form-input rotaryfocus" name="submit" type="submit" value="Send"><?=$languageService->translate('send')?></button>
        <?php endif; ?>
    </form>
