    ...
    <div class="max-w-lg bg-white px-6 py-8 relative z-20 flex rounded text-lg">
        ...
        <?php if ($config['qr']['wifi_enabled']) {
            ...
            echo '<div class="mr-8 flex flex-col items-center justify-center">
                    <h2 class="flex flex-col text-brand-1 font-bold text-2xl"><span data-i18n="qr_step_one"></span></h2>
                ...
                '</div>
                    <div class="flex flex-col mt-auto">
                        ...
                        <h2 class="w-full bg-brand-1 rounded-b text-white text-center pb-1"><span data-i18n="wifi"></span></h2>
                    </div>
                </div>';
        } ?>
        ...
        <div class="flex flex-col items-center justify-center">
            <?php if ($config['qr']['wifi_enabled']) {
                ...
                echo '<h2 class="flex flex-col text-brand-1 font-bold text-2xl"><span data-i18n="qr_step_two"></span></h2>';
            } else {
                $qrStepTwoLong = $config['qr']['custom_text'] ? $config['qr']['text'] : '<span data-i18n="qr_step_two_long"></span>';
            } ?>
            ...
            <div class="flex flex-col mt-auto">
                ...
                <h2 class="w-full bg-brand-1 rounded-b text-white text-center pb-1"><span data-i18n="your_picture"></span></h2>
            </div>
        </div>
