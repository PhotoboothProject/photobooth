...
function getNavItem($label, $hidden)
{
    ...
    $className = '
            ...
            hover:bg-content-1 hover:bg-content-1/10 hover:z-10 hover:text-brand-1
    ...
    return '<li class="pb-4 -mt-4 relative">
                <a id="nav-' . $label . '" class="' . $className . '" ' . $href . '" onclick="toggleAdminNavi()">
                    ...
                    <span class="naviLabel">' . $languageService->translate($label) . '</span>
